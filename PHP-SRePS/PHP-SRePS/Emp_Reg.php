...
<tr><td>Date of Birth:</td><td><input style="width:200px" type="date" name="emp_dob"></td></tr>
<tr><td>Status:</td><td>Active</td><input type="hidden" name="emp_status" value = "Active"></td></tr>
<tr></tr>
<tr></tr>
<tr><td><td><td align = "top"><input type="submit" value="Submit" name="Submit"></td>
</form>

<!-- Form back to Login screen-->
<form action="index.html" method = "post">
<td></td><td align="center"><input type="submit" value="Back To Login"></td></tr>
</form>
